...
-- CreateIndex
CREATE UNIQUE INDEX "DaysAvailable_availabilityId_key" ON "DaysAvailable"("availabilityId");
...
-- AddForeignKey
ALTER TABLE "DaysAvailable" ADD CONSTRAINT "DaysAvailable_availabilityId_fkey" FOREIGN KEY ("availabilityId") REFERENCES "Availability"("id") ON DELETE CASCADE ON UPDATE CASCADE;
